...
class GetFieldValueTest(unittest.TestCase):
    ...
    def test_get_field_value_collect(self):
        ...
        a = "Q://100_data/work/assets/character/quen01/Model/LO/user/go.hattori.ts/maya/scenes/quen01_Model_LO_<private_version>.ma"
        b = "Q:/100_data/work/assets/character/quen01/Model/LO/user/go.hattori.ts/maya/scenes/quen01_Model_LO_03.ma"
        actual = self.obj.get_field_value(a, b)
        print actual
